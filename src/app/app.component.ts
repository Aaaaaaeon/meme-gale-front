  ...
  template: `
    ...
    <div class="navbar bg-base-300">
      <div class="navbar-start">
        <a routerLink="/gallery" class="btn btn-ghost text-xl">🎭 Meme Gallery</a>
      </div>
      ...
      <div class="navbar-end gap-2">
        @if (isAuthenticated()) {
          ...
          <a routerLink="/login" class="btn btn-primary btn-sm">Connexion</a>
        }
        ...
        <label class="swap swap-rotate btn btn-ghost btn-circle btn-sm">
          ...
          <svg class="swap-off fill-current w-5 h-5" viewBox="0 0 24 24">
...
export class AppComponent {
  ...
  logout(): void {
    this.authService.logout().subscribe({
      ...
      error: () => {
        // Force logout localement même si le serveur échoue
        window.location.href = '/login';
      }
    });
  }
